...
/** First-generation court silhouettes (sota, caballo, rey) for the Silueta deck. */
export default function MusFigureSolid({ rank, height = 48, color, className }: Props) {
  const common = {
    height, width: (height * 40) / 56, viewBox: "0 0 40 56", className, style: { color }, fill: "currentColor",
  } as const;
